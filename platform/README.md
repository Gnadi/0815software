...
| PS-11 | Customers        | Party master data shared by every module  | 4011     | Available |
...
- [PS-11 · Customers](./ps-11-customers) — party master data: one answer to
  "who is this customer?" across every module, with deterministic matching
  (reference, VAT id, email), per-module references, and the stack owner's own
  `self` party as the single home for the seller identity.
