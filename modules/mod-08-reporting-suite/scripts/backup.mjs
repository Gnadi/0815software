...
// Generated exports live on disk, not in the database. They are copied alongside
...
const filesSrc = process.env.EXPORTS_DIR ?? './exports';
if (existsSync(filesSrc)) {
  const filesDest = join(dir, `exports-${stamp}`);
