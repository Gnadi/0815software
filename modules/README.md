...
The 0815software module catalogue: sixteen standard modules for standard
business problems, each shipped MIT-licensed with full source code. This
directory holds the implementations. **All sixteen modules are now
...
Ticket System, MOD-13 Offers, MOD-14 Subsidies & Funds, MOD-15 Absence &
Leave Management and MOD-16 Whistleblowing. See the
...
| MOD-16 | Whistleblowing        | **Available** | [mod-16-whistleblowing](./mod-16-whistleblowing) |
...
The same file carries the twelve Platform Services with their ports, Caddy route
...
**All sixteen modules ship this wiring** (each has a `server/platform.ts` and
