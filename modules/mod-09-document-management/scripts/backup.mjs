...
// Uploaded documents live on disk, not in the database. They are copied alongside
...
const filesSrc = process.env.STORAGE_DIR ?? './storage';
if (existsSync(filesSrc)) {
  const filesDest = join(dir, `storage-${stamp}`);
