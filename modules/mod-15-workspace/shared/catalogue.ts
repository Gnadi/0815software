/**
 * THE MODULE CATALOGUE — which modules this Workspace knows how to host.
 *
 * One entry per module in the 0815software catalogue, naming the two env vars
 * that point at it and whether it can be embedded. It is the Workspace's half
 ...
 *
 * - `urlEnv` is the INTERNAL address (`http://offers:3013`). The Workspace's
 ...
 * (docs/PLATFORM-READINESS.md, item C1). The Workspace has no principal to
