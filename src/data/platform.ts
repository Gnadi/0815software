...
export const platform: PlatformService[] = [
  {
    ...
    title: 'Identity',
    purpose:
      'Shared authentication and authorization — one login, one set of users and roles, strict multi-tenancy, and SSO against the identity provider the customer already runs.',
    status: 'Available',
    port: 4001,
    ...
    api: [
      ...
      'SCIM 2.0 at /scim/v2 (Users, Groups, ServiceProviderConfig)',
    ],
